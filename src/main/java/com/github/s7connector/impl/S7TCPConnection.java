...
public final class S7TCPConnection extends S7BaseConnection {
	...
	/**
	 * Connection type: 1 = PG 2 = OP 3 = S7 Basic 4-10 = Generic
	 */
	 ...
	 * @throws S7Exception
	 */
	public S7TCPConnection(final String host, final int type, final int rack, final int slot, final int port,
			final int timeout, final SiemensPLCS plcType) throws S7Exception {
		this.host = host;
		this.type = type;
		this.rack = rack;
		this.slot = slot;
